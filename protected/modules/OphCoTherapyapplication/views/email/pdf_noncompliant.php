			...
			<table class="layout">
				<tbody>
					<tr nobr="true">
						...
						<span class="form-text">&nbsp;Visual Acuity:</span><?php echo ($exam_api && ($va = $exam_api->getLetterVisualAcuityForEpisodeBoth($event->episode->patient, true))) ? Yii::app()->format->Ntext($va) : 'Not measured'; ?><br />
